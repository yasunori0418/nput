...
specification_ja: |
  ...
  ため）。
---
# QA-0d42104c: リファレンスドキュメントは記述対象のソースから生成し、生成物を持たない
