...
---
# QA-67715bb3: 規範は 1 ファイル 1 item のグラフが持ち、概要文書は索引に縮退させる
...
素通りするため（QA-6bf957d9 の検証は参照の解決・一意性・非循環しか見ない）、正しい型へ置く
...
規約は `docs/agents/sara-graph.md` が、採番の仕組みは INF-659b139d が持つ。
