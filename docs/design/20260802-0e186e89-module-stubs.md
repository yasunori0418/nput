...
実装スコープの線引き（DSG-4a84f282）が MVP を standalone CLI + project mode + home mode に
限ることの帰結で、E2E の対象外である旨は REQ-690f2730 が定めている。

## 出典

`docs/design.md`「flake.nix outputs 設計」のモジュール統合の項（L104-105）。
