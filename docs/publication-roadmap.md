...
**位置づけ**: 進捗の一次情報は tracking issue #91。本書は公開時点（2026-06-22）の計画のスナップショットであり、公開後の進捗・完了状況は #91 を参照する。

最終更新: 2026-06-22（完了状況の同期・#91 位置づけ明記: 2026-07-03、#113）
