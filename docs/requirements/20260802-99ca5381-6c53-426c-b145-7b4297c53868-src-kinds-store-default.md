...
---
# REQ-99ca5381-6c53-426c-b145-7b4297c53868: src は path / set / marker の 3 種を取り store link を既定として out-of-store は marker で opt-in する
...
marker が何を返すか（`mkOutOfStoreSymlink` の責務）は REQ-eb363122-385a-499c-a074-c95efb949d07、marker と
derivation の判別方式は REQ-1dcc9a33-b0f2-43e0-8310-fc4b19e68fe7 が持つ。本 item は `src` が取る値の種別と、
