...
specification: |
  ...
  Which external commands it may invoke at run time is stated by REQ-6c4e174a-4d16-477a-96ff-17cb4eb5b564 and SHALL NOT
  be restated here.
specification_ja: |
  ...
  ならない。
  実行時に叩いてよい外部コマンドは REQ-6c4e174a-4d16-477a-96ff-17cb4eb5b564 の規範であり、ここでは再掲しない。
---
# REQ-b74a118a-1272-44eb-944c-7725163211c6: engine は第三者依存ゼロの stdlib-only とし内部層に閉じる
...
> `git` に限ることは REQ-6c4e174a-4d16-477a-96ff-17cb4eb5b564、engine が `manifest.json` を入力に取る 2 層構成は
> REQ-f4d7d4ab-fbdb-48c6-b29f-08dd88e72645、その `manifest.json` が唯一の安定契約であることは REQ-79ce0a09-f9bd-4e61-ba7f-45fb5643137b の担当。
...
限定そのものの帰属は REQ-6c4e174a-4d16-477a-96ff-17cb4eb5b564 が担当する）。
