...
---
# REQ-37b56673-6e40-4a1b-a2a7-5d3c084e3e66: root は 3 マーカーと絶対パス文字列の union を取る
...
home mode と project mode は世代の扱いが異なる。この差異そのものは REQ-46fccb80-4bae-4d37-bc19-dded88e9a9c0 の担当で、
...
> 「将来」の限定を規範文へ持ち込まない判断をした（REQ-16faf428-77f3-492f-b858-222c5274cbf7 で同じ ADR-0036 由来の
> 未追従を扱ったのと同じ扱い）。
>
...
> モード）に留め、適用形は担当範囲外とする（REQ-3f541d39-da41-4ef8-858b-707f54cf6a29 に同じ注記）。
>
