...
specification: |
  ...
  `nput.*`. That a profile is atomic per config is stated by REQ-1be4d678-959c-44d7-a346-44bfd95af56e and is not
  restated here.
specification_ja: |
  ...
  config 単位で atomic で
  あることは REQ-1be4d678-959c-44d7-a346-44bfd95af56e の担当で、本 item では規定しない。
---
# REQ-c2d44626-d8f4-446a-a80a-319a500129b4: apply の config 選択は name 省略で default・明示で単一・--all で全件
...
> root モードフィルタは本 item の規範ではなく、REQ-4cbd9a0d-9f94-4747-8881-56020dc6d5af / REQ-d95b814f-aa7a-470e-9320-c14f9c14da7b の担当。
> profile の atomic 性そのもの（→ ADR-0002）は REQ-1be4d678-959c-44d7-a346-44bfd95af56e の担当。
