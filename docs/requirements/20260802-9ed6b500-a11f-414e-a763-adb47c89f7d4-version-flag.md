...
---
# REQ-9ed6b500-a11f-414e-a763-adb47c89f7d4: --version は埋め込みバージョンを cobra 既定書式で表示して終了し短縮形を持たない
...
`--version` がエンベロープを出さないこと（`--json` との関係）は REQ-5c2e64c3-09a7-4ae8-b60c-4f1ccabce4fd の担当。
