...
specification_ja: |
  ...
  差し替えで再利用しなければならない。
---
# REQ-0e341430-17f0-498b-9439-65491652163a: rollback は FS を先に収束させてから profile ポインタを最後に移す
...
> - module で `nput rollback` を公開せず host へ一本化すること → REQ-844ee375-919f-4341-81e1-a5f89fd32840
> - project mode で rollback を公開しないこと → REQ-46fccb80-4bae-4d37-bc19-dded88e9a9c0
> - `rollback` が名指し必須で `--all` に対応しないこと・`list-generations` が home mode 限定で
>   あること → REQ-89c7baf9-9be0-417b-bd2d-b2e4edabe796 / REQ-05abce3e-9797-432b-b93f-37c55d09afde
> - 途中失敗時に undo ジャーナルで巻き戻すこと → REQ-5e75aabc-0e8f-4a6c-92bd-a712dc68a940
> - 配置前除去の判定そのもの → REQ-c9ab91c1-f778-4f87-a2ea-c66d6b3c2575
