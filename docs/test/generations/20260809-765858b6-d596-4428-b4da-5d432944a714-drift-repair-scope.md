...
---
# TC-765858b6-d596-4428-b4da-5d432944a714: lstat ドリフト修復が壊れた entry だけを直し、ユーザーの編集には触れない
...
CASE-2de3a3d8-3b67-485a-8ddf-a97dd182af23（`internal/engine/drift_test.go`）。`--backup` が同じ修復経路で発火する
側は atomicity の TC-ed4992c0-8513-4383-be0a-e45acbbc229f が担当する。
