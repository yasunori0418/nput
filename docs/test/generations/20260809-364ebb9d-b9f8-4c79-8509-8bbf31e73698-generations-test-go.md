...
---
# CASE-364ebb9d-b9f8-4c79-8509-8bbf31e73698: generations_test.go — 世代一覧パース・rollback の再収束と失敗経路
...
→ CASE-31fdb776-9650-4ff9-97f6-45d56b2e7177 / TC-b254a5a8-7fbf-4f31-8486-3e373d66bfa7、issue #328）。

## 検証内容

**世代一覧のパース**（TC-746cb5b9-fe27-4d09-a51d-eb03d56a93a7）

- 番号・日時・`(current)` マーカーの分解。日時に `(current)` を混入させない
- 空入力は 0 件でエラーにしない
- 世代番号が非数値の行はエラーにする

**rollback の再収束**（TC-36ea3609-d52e-42d4-975c-40fb89b23919）
...
**rollback の失敗経路**（TC-fa7911c6-7347-47ff-b121-bec53562c063）
